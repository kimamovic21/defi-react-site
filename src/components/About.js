                ...
                <div className='card-container'>
                    <div className='card'>
                         ...
                         text='Use decentralization, trusted nodes, premium data,
                               and cryptographic proofs to connect highly accurate
                               and available data/APIs to any smart contract.'
                         />
                    </div>
                    <div className='card'>
                         <AboutCard
                         ...
                         text='Build on a flexible framework that can retrieve data 
                              from any API, connect with existing systems, and 
                    ...
                    <div className='card'>
                        ...
                        text='Integrate pre-built, time-tested oracle solutions
                             that already secure tens of billions in smart contract
